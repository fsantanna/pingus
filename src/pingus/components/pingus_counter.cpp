...
PingusCounter::draw(DrawingContext& gc)
{
  ...
  snprintf(str, 128, _("Released:%3d/%d   Out:%3d   Saved:%3d/%d").c_str(),
           world->get_pingus()->ceu->number_of_released,
           world->get_pingus()->ceu->number_of_allowed,
           world->get_pingus()->ceu->number_of_alive,
           world->get_pingus()->ceu->number_of_exited,
