...
PingusCounter::draw(DrawingContext& gc)
{
  ...
  snprintf(str, 128, _("Released:%3d/%d   Out:%3d   Saved:%3d/%d").c_str(),
           CEU_World_get_pingus(NULL, world->ceu)->number_of_released,
           CEU_World_get_pingus(NULL, world->ceu)->number_of_allowed,
           CEU_World_get_pingus(NULL, world->ceu)->number_of_alive,
           CEU_World_get_pingus(NULL, world->ceu)->number_of_exited,
